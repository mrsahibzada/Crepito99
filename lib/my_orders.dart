...
class OrderItem extends StatelessWidget{
  ...
  var qty;
  int feedBack;
  OrderItem(this.deliveryCharges,this.totalBill,this.state,this.items,this.prices,this.qty,this.timeStamp,this.orderStatus,this.feedBack);
  @override
  Widget build(BuildContext context) {
            ...
            Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  state==0 ?
                      JumpingText("Processing...", style:TextStyle(
                          color: Colors.white,
                          fontFamily: "Roboto",
                          fontWeight: FontWeight.w300,
                          fontSize: 18)
    ...
    RaisedButton(
      onPressed: (){
        Navigator.of(context)
            .push(MaterialPageRoute(builder: (context) => TrackOrder(deliveryCharges.toString())));
